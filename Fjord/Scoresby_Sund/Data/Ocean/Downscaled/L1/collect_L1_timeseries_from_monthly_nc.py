...
def read_transect_file(config_dir):
    ...
    transect_file = os.path.join(config_dir,model_level,'grid',model_name,'results',
...
output_dir = '/Users/mhwood/Documents/Research/Projects/Scoresby Sund/Data/Modeling/Downscaled/L1_CE_Greenland'
output_file = 'L1_CE_Greenland_THETA_Timeseries.nc'
