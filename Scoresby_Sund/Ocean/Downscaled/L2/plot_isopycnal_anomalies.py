...
def plot_transect_timeseries(config_dir,output_dir):
...
output_dir = '/Users/mhwood/Documents/Research/Projects/Scoresby Sund/Figures/Ocean'

plot_transect_timeseries(config_dir, output_dir)
