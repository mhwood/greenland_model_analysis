...
def write_profile_timeseries_to_nc(project_folder, model_name, location, dec_yrs, depths, profiles, var_name):

    ds = nc4.Dataset(os.path.join(project_folder, 'Data', 'Ocean', 'L1', model_name+'_'+location+'_'+var_name+'_timeseries.nc'),'w')
...
def create_model_profile_timeseres(project_folder, config_folder, var_name):
    ...
    write_profile_timeseries_to_nc(project_folder, model_name, location, dec_yrs, depths, profiles, var_name)


project_folder = '/Users/mhwood/Documents/Research/Projects/North Greenland'


config_folder = '/Volumes/jakobshavn/Research/Projects/Ocean_Modeling/Projects/Downscale_Greenland/MITgcm/' \
