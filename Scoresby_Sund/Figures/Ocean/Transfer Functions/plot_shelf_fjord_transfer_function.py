...
def plot_theta_shelf_fjord_transfer_functions(project_folder,
    ...
    plt.subplot(2,3,1)
    for i in range(N):
        plt.plot(shelf_model_theta[:,i],model_depth,'-',linewidth=0.4,color='silver')
    ...
    plt.subplot(2, 3, 2)
    for i in range(N):
        plt.plot(fjord_model_theta[:, i], model_depth, '-', linewidth=0.4, color='silver')
    ...
    plt.subplot(2, 3, 3)
    for i in range(N):
        plt.plot(fjord_model_theta[:, i] - shelf_model_theta[:, i], model_depth, '-', linewidth=0.4, color='silver')
    ...
    for i in range(len(shelf_ctd_profiles)):
        plt.plot(shelf_ctd_profiles[i][:, 1], shelf_ctd_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
    ...
    for i in range(len(fjord_ctd_profiles)):
        plt.plot(fjord_ctd_profiles[i][:, 1], fjord_ctd_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
    ...
    for i in range(len(fjord_ctd_profiles)):
        plt.plot(fjord_ctd_profiles[i][:, 1] - shelf_ctd_profiles[i][:, 1], fjord_ctd_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
...
def plot_theta_and_salt_shelf_fjord_transfer_functions(project_folder,  #model_time, model_depth,
    ...
    for i in range(len(shelf_model_theta_profiles)):
        if i==0:
            plt.plot(shelf_model_theta_profiles[i][:, 1], shelf_model_theta_profiles[i][:, 0],
                     '-', linewidth=0.4,color='silver', label='Individual\nProfile')
        else:
            plt.plot(shelf_model_theta_profiles[i][:, 1], shelf_model_theta_profiles[i][:, 0],
                     '-', linewidth=0.4, color='silver')
    ...
    for i in range(len(fjord_model_theta_profiles)):
        plt.plot(fjord_model_theta_profiles[i][:, 1], fjord_model_theta_profiles[i][:, 0], '-', linewidth=0.4,
                 color='silver')
    ...
    for i in range(len(fjord_model_theta_profiles)):
        plt.plot(fjord_model_theta_profiles[i][:, 1] - shelf_model_theta_profiles[i][:, 1],
                 fjord_model_theta_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
    ...
    plt.plot(mean_shelf_profile[:,1], mean_shelf_profile[:,0], '--', color='r',label='Interp.\nDownward',alpha=0.6)
    shallow_indices = mean_shelf_profile[:, 0] < 400
    ...
    for i in range(len(fjord_ctd_theta_profiles)):
        plt.plot(fjord_ctd_theta_profiles[i][:, 1], fjord_ctd_theta_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
    ...
    for i in range(len(fjord_ctd_theta_profiles)):
        plt.plot(fjord_ctd_theta_profiles[i][:, 1] - shelf_ctd_theta_profiles[i][:, 1], fjord_ctd_theta_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
    ...
    for i in range(len(shelf_model_salt_profiles)):
        plt.plot(shelf_model_salt_profiles[i][:, 1], shelf_model_salt_profiles[i][:, 0], '-', linewidth=0.4,
                 color='silver')
    ...
    for i in range(len(fjord_model_salt_profiles)):
        plt.plot(fjord_model_salt_profiles[i][:, 1], fjord_model_salt_profiles[i][:, 0], '-', linewidth=0.4,
                 color='silver')
    ...
    for i in range(len(fjord_model_salt_profiles)):
        plt.plot(fjord_model_salt_profiles[i][:, 1] - shelf_model_salt_profiles[i][:, 1],
                 fjord_model_salt_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
    ...
    plt.plot(mean_shelf_profile[:, 1], mean_shelf_profile[:, 0], '--', color='b',label='Interp.\nDownward')
    shallow_indices = mean_shelf_profile[:, 0] < 400
    ...
    for i in range(len(fjord_ctd_salt_profiles)):
        plt.plot(fjord_ctd_salt_profiles[i][:, 1], fjord_ctd_salt_profiles[i][:, 0], '-', linewidth=0.4, color='silver')
